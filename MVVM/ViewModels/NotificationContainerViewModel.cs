...
public class NotificationContainerViewModel : INotifyPropertyChanged {
    ...
    public NotificationContainerViewModel() {
        ...
        _notifications.CollectionChanged += (s, e) => { NotificationCount = _notifications.Count; };
    }

    public void ShowNotification(string title, string message, NotificationType type = NotificationType.Info,
        float autoCloseDurationInSeconds = 7) {
        ...
        Task.Delay(TimeSpan.FromSeconds(autoCloseDurationInSeconds)).ContinueWith(_ => {
